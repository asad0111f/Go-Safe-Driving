...
async def run_test():
    ...
    try:
        ...
        # -> Fill in the phone field with '123-456-7890'
        frame = context.pages[-1]
        # Fill in the phone field with '123-456-7890'
        ...
        # -> Fill in the preferred date/time field with a valid future date and time
        frame = context.pages[-1]
        # Fill in the preferred date/time field with a valid future date and time
        elem = frame.locator('xpath=html/body/div[2]/div/div/div/div[2]/div/div/form/div[4]/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('2025-11-06T10:00')
